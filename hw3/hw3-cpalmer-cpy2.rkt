...
(define (remove-min lst cmp)
  (list (lst-min lst cmp) (lst-remove lst (lst-min lst cmp))))
...
(test (lambda () (remove '(1 2 3 3) 1)) '(2 3 3) "remove 1")
...
;(nclassify mptlist3 false 10)
;(ptcomparator '(0 -2) '(18 22))
